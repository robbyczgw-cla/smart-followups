...
<p align="center">
  <a href="https://moltbot.com"><img src="https://img.shields.io/badge/🦎_Moltbot-Skill-7c3aed?style=for-the-badge" alt="Moltbot Skill"></a>
...
**This is a skill for [Moltbot](https://moltbot.com)** — the AI assistant that works across Telegram, Discord, Signal, WhatsApp, and more.
...
- **🔐 Privacy-First** — Uses your existing Moltbot auth by default
...
[Moltbot](https://moltbot.com) is a powerful AI assistant that connects Claude to your favorite messaging apps — Telegram, Discord, Signal, WhatsApp, iMessage, and more. Skills extend Moltbot with new capabilities.

**Not using Moltbot yet?** Check out [moltbot.com](https://moltbot.com) to get started!
...
Just say **"followups"** (or "give me follow-ups", "suggestions") in any Moltbot conversation:
...
> **Note:** This works as a keyword the agent recognizes, not as a registered `/slash` command. Moltbot skills are guidance docs — the agent reads the SKILL.md and knows how to respond when you ask for follow-ups.

---

## 🔐 Authentication Options

### Option 1: Moltbot Native (Default) ⭐

**Uses your existing Moltbot authentication** — same model and login as your current chat.
...
Works on **every Moltbot channel** with adaptive formatting:
...
### Can I use this without Moltbot?

Yes! The CLI tool works standalone with OpenRouter or Anthropic API keys. But the best experience is integrated with Moltbot.
...
Yes! With `provider: "moltbot"` (default), it uses whatever model your current chat is using. With other providers, specify the model in config.

### Is my conversation data sent anywhere?

**With Moltbot native:** Same privacy as your normal chat — processed by your configured AI provider.
...
- **Moltbot native:** Uses your existing chat's API usage
...
├── handler.js              # Moltbot command handler
├── package.json
├── README.md               # This file
...
- Built for the [Moltbot](https://moltbot.com) ecosystem
- Powered by Claude
